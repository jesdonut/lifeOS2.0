// core/settings.js — settings modal shell + Profile/Calendar/Spending/Appearance sections.
// The Data section lives in ./settings/data.js; shared helpers in ./settings/util.js.

import { renderData } from './settings/data.js';
import { sectionLabel, field, esc } from './settings/util.js';
...
function renderSection(el, id) {
  ...
  else if (id === 'data')       renderData(el, closeSettings);
}
